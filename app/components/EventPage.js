  ...
  render() {
    return(
      <View style={this.props.style}>
        <EventCell key={0} partOfFavorites={this.props.partOfFavorites} cellPressed={(cellInfo) => this.props.cellPressed(cellInfo)} large={true} eventInfo={this.props.eventsForPage.length >= 1 ? this.props.eventsForPage[0]: {}} style={{width:this.props.width,height:this.props.height*.75,borderBottomWidth:1,borderBottomColor:'#EEEEEE'}}/>
