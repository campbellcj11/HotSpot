      ...
      <View style={{flex:1,paddingTop:20}}>
        ...
        <View style={{flex:.1,flexDirection:'row',justifyContent:'space-between',alignItems:'center',marginHorizontal:8}}>
          <View style={{flex:.15,justifyContent:'center',alignItems:'center'}}>
            <ImageButton image={addImage} style={{marginLeft:8,width:24,height:24,borderWidth:1,borderColor:'white',borderRadius:16,backgroundColor:this.state.postcardInfo.color}} imageStyle={{width:8,height:8,tintColor:'white'}} onPress={() => this.openImagePicker()}>
            </ImageButton>
          </View>
          ...
          <View style={{flex:.15,justifyContent:'center',alignItems:'center'}}>
            <ImageButton image={closeImage} style={{marginRight:8,width:24,height:24,borderWidth:1,borderColor:'white',borderRadius:16,backgroundColor:this.state.postcardInfo.color}} imageStyle={{width:8,height:8,tintColor:'white'}} onPress={() => this.closePostCardSettings()}>
            </ImageButton>
          </View>
        </View>
        <SortableGrid
    ...
    return(
      <View key={-1} style={{flex:1,backgroundColor:'red'}}>
        ...
        <View style={{flexDirection:'row',marginTop:20+32,alignItems:'center'}}>
          <View style={{flex:.15,justifyContent:'center',alignItems:'center'}}>
            <ImageButton image={settingsImage} style={{marginRight:8,width:24,height:24,borderWidth:1,borderColor:'white',borderRadius:16,backgroundColor:this.state.postcardInfo.color}} imageStyle={{width:12,height:12,tintColor:'white'}} onPress={() => this.openPostCardSettings()}>
            </ImageButton>
          </View>
          <Text style={{flex:.7,backgroundColor:'transparent',fontFamily:styleVariables.systemBoldFont,fontSize:24,color:'white',textAlign:'center'}}>{this.state.postcardInfo.name}</Text>
          <View style={{flex:.15,justifyContent:'center',alignItems:'center'}}>
            <ImageButton image={closeImage} style={{marginRight:8,width:24,height:24,borderWidth:1,borderColor:'white',borderRadius:16,backgroundColor:this.state.postcardInfo.color}} imageStyle={{width:8,height:8,tintColor:'white'}} onPress={() => this.closePostCard()}>
            </ImageButton>
          </View>
        </View>
